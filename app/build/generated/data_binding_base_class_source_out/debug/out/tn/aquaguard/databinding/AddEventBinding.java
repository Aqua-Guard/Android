...
public final class AddEventBinding implements ViewBinding {
  ...
  private AddEventBinding(@NonNull LinearLayout rootView, @NonNull Button btnsubmit,
      @NonNull ImageView cancelButton, @NonNull TextView createText,
      @NonNull EditText editTextEndDate, @NonNull EditText editTextStartDate,
  ...
  public static AddEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText editTextEndDate = ViewBindings.findChildViewById(rootView, id);
      if (editTextEndDate == null) {
        break missingId;
      }

      id = R.id.editTextStartDate;
      EditText editTextStartDate = ViewBindings.findChildViewById(rootView, id);
      ...
      return new AddEventBinding((LinearLayout) rootView, btnsubmit, cancelButton, createText,
          editTextEndDate, editTextStartDate, layoutVideo);
    }
